...
public class DataDrivenTesting extends CommonToAllTest {
    ...
    public void test_vwo_login(String email, String password) {
        ...
        String error_msg = loginPage.loginToVWOLoginInvalidCred(email,password);
